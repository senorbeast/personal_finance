...
class User extends amplify_core.Model {
  ...
  const User._internal({required this.id, required email, required balance, required accountNo, Transactions, createdAt, updatedAt}): _email = email, _balance = balance, _accountNo = accountNo, _Transactions = Transactions, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory User({String? id, required String email, required double balance, required String accountNo, List<Transaction>? Transactions}) {
  ...
  String toString() {
    ...
    buffer.write("accountNo=" + "$_accountNo" + ", ");
  ...
  User copyWith({String? email, double? balance, String? accountNo, List<Transaction>? Transactions}) {
    return User._internal(
      id: id,
  ...
  User copyWithModelFieldValues({
    ...
    ModelFieldValue<String>? accountNo,
    ...
    return User._internal(
      ...
      accountNo: accountNo == null ? this.accountNo : accountNo.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'email': _email, 'balance': _balance, 'accountNo': _accountNo, 'Transactions': _Transactions?.map((Transaction? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final ACCOUNTNO = amplify_core.QueryField(fieldName: "accountNo");
